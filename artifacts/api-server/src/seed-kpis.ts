...
const KPIS: KpiDef[] = [
  ...
  },
  {
    ...
    name: "Internal processes digitized (%)",
    kpiType: "rate", direction: "higher",
    pillar: "Operational Excellence",
    formula: "Digitized processes / Total processes × 100",
    category: "Digital Transformation",
    measurementFrequency: "annual",
    baseline: 13, target2025: 23, target2026: 35, target2027: 48, target2028: 60, target2029: 72, target2030: 85,
    unit: "%",
  },
  {
    ...
    name: "Compliance to NCA requirements in KSA (%)",
    kpiType: "rate", direction: "higher",
    pillar: "Technology & Innovation",
    formula: "NCA controls implemented / Total required controls × 100",
    category: "Cybersecurity",
    measurementFrequency: "annual",
    baseline: null, target2025: 70, target2026: 80, target2027: 85, target2028: 90, target2029: 95, target2030: 100,
    unit: "%",
  },
  {
    num: 32, type: "strategic",
    name: "Digital transformation maturity index (%)",
    kpiType: "rate", direction: "higher",
    pillar: "Technology & Innovation",
    formula: "Digital maturity assessment score (weighted dimensions)",
    category: "Digital Transformation",
    measurementFrequency: "annual",
  ...
  // ── Capabilities Building (34-38) ─────────────────────────────────────────
  {
    ...
    kpiType: "rate", direction: "higher",
    pillar: "Capability Building",
    formula: "(Total - Voluntary departures) / Total × 100",
  ...
  },
  {
    ...
    name: "Marketing events to strengthen KFCA brand (#)",
    kpiType: "cumulative", direction: "higher",
  ...
  },
  {
    ...
    name: "Compliance to Universal Accessibility (%)",
    kpiType: "cumulative", direction: "higher",
    pillar: "Branding & Social",
  ...
  // ── PS Participation & Funding (41-42) ──────────────────────────────────
  {
    num: 41, type: "operational",
  ...
  {
    num: 42, type: "operational",
    name: "Mobile app revenues (JESR) (SAR)",
    kpiType: "cumulative", direction: "higher",
    pillar: "Technology & Innovation",
    formula: "Total JESR mobile application revenue",
    category: "Revenue",
    measurementFrequency: "annual",
    baseline: null, target2025: null, target2026: 500000, target2027: 1000000, target2028: 2000000, target2029: 3500000, target2030: 5000000,
    unit: "SAR",
  },
];
