...
const FEATURE_GRID: { icon: keyof typeof Ionicons.glyphMap; label: string; color: string; bg: string; route: string }[] = [
  { icon: "analytics-outline", label: "KPIs", color: "#2563EB", bg: "#EFF6FF", route: "/kpis" },
  { icon: "warning-outline", label: "Risks", color: "#D97706", bg: "#FFFBEB", route: "/risks" },
  { icon: "document-text-outline", label: "Documents", color: "#7C3AED", bg: "#F5F3FF", route: "/documents" },
  { icon: "notifications-outline", label: "Notifications", color: "#EF4444", bg: "#FEF2F2", route: "/notifications" },
];
    ...
    <ScrollView style={{ flex: 1, backgroundColor: "#F8FAFC" }} contentContainerStyle={{ padding: 16, gap: 20, paddingBottom: 32 }}>
      ...
      <View style={{
        ...
        <View style={{ flexDirection: "row", alignItems: "center", gap: 14 }}>
          <View style={{ width: 52, height: 52, borderRadius: 26, backgroundColor: "#0F172A", alignItems: "center", justifyContent: "center" }}>
