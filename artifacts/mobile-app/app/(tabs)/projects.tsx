...
function ProjectItem({ project, onPress }: { project: { id: number; name: string; projectCode: string | null; progress: number; status: string; computedStatus?: { status: string } }; onPress: () => void }) {
  ...
  return (
    <Pressable onPress={onPress} style={{ backgroundColor: "#FFFFFF", borderRadius: 16, padding: 16, shadowColor: "#000", shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.06, shadowRadius: 8, elevation: 3, borderLeftWidth: 4, borderLeftColor: s.color }}>
